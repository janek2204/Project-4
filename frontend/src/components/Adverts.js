    ...
    <>
      ...
      >
        <Dropdown.Menu>
          ...
          <Dropdown.Divider />
          <Dropdown.Item id="ELECTRONICS" onClick={handleClick}>
            Electronics
          </Dropdown.Item>
          <Dropdown.Item id="OTHER" onClick={handleClick}>
            Other
          </Dropdown.Item>
          <Dropdown.Item id="CARS" onClick={handleClick}>
            Cars
          </Dropdown.Item>
          <Dropdown.Item id="GARDEN" onClick={handleClick}>
            Garden
          </Dropdown.Item>
          <Dropdown.Item id="HOME" onClick={handleClick}>
            Home
          </Dropdown.Item>
          <Dropdown.Divider />
